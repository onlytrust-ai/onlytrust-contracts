...
interface IOnlyTrustEscrowRouter {
    ...
    function claimSettlement(bytes32 taskId, uint256 deadline, bytes calldata signature) external;
    function refund(bytes32 taskId, uint256 deadline, bytes calldata signature) external;
